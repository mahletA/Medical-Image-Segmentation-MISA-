...
% Load 3D data
img = load_nii('D:\MAIA_Masters\Semester3_Spain\MISA\l1_preprocessing\Lab1\results\pn5_rf20_filtered.nii');
shape = size(img.img);

% Apply MICO on each slice
for slice = 1:shape(3)
    ...
    % Save results
    save_nii(img, './Results/pn4_rf20_bc.nii');
    end
end
